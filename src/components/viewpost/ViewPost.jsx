...
import { axiosInstance, PF_path as PF } from '../../config'
  ...
  return (
    <div className="viewpost">
      <div className="viewPostWrapper">
        ...
        {post.photo && (
          <img className="viewPostImg" src={PF + post.photo} alt="" />
        )}
          ...
          <h1 className="viewPostTitle">
            ...
            {post.username === user?.username && (
              <div className="viewPostEdit">
                <i
                  className="viewPostIcon far fa-edit"
                  onClick={() => setUpdateMode(true)}
                ></i>
                <i
                  class="viewPostIcon far fa-trash-alt"
        ...
        {updateMode ? (
          <textarea
            className="viewPostDescInput"
            value={desc}
            onChange={(e) => setDesc(e.target.value)}
          />
        ) : (
          <p className="viewPostDesc">{desc}</p>
        )}
        {updateMode && (
